...
io.on('connection', (socket) => {
    ...
    socket.on('updateTeamInfo', (data) => {
        ...
        gameState.homeLogo = data.homeLogo;
        gameState.awayLogo = data.awayLogo;
        io.emit('stateUpdate', gameState);
    });
    ...
    // Puente de comunicación para los Cambios / Sustituciones
...
const PORT = 3000;
server.listen(PORT, () => {
    console.log(`Servidor de gráficos corriendo en http://localhost:${PORT}`);
});